...
############################################################
# 0. Disparity functional and helper 
############################################################
...
set.seed(2025)
pop = gen_population(N_pop = N_pop, H = H, K = K, sigma_u = 1.2)
...
print(res_tbl)
write.csv(res_tbl,"Results_DWOLB/comparison_twostage_stratified_cluster_moderate_clustering.csv")
```
...
print(res_tbl2)
write.csv(res_tbl2,"Results_DWOLB/comparison_twostage_stratified_cluster_strong_clustering.csv")
